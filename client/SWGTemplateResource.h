...
/*
 * SWGTemplateResource.h
 * 
 * 
 */

#ifndef SWGTemplateResource_H_
#define SWGTemplateResource_H_
...
class SWGTemplateResource: public SWGObject {
public:
    SWGTemplateResource();
    SWGTemplateResource(QString* json);
    virtual ~SWGTemplateResource();
    void init();
    void cleanup();
    ...
    SWGTemplateResource* fromJson(QString &jsonString);
