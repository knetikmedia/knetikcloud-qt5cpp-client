...
#ifndef SWGShippingItem_H_
#define SWGShippingItem_H_
...
class SWGShippingItem: public SWGObject {
public:
    SWGShippingItem();
    SWGShippingItem(QString* json);
    virtual ~SWGShippingItem();
    void init();
    void cleanup();
    ...
    SWGShippingItem* fromJson(QString &jsonString);
    ...
    QList<QString*>* getCountries();
    void setCountries(QList<QString*>* countries);
    ...
    qint32 getMaxTierTotal();
    void setMaxTierTotal(qint32 max_tier_total);
